/* Base Code ÃâÃ³ : 2017³â ¾Ë°í¸®Áò °æÁø´ëÈ¸ "ÇÇ»Ñ¸®´Â ÄÄÆÄÀÏ·¯" ÆÀ ÄÚµå */
...
/// º¿ ÇÁ·Î±×·¥ °³¹ßÀÇ ÆíÀÇ¼º Çâ»óÀ» À§ÇØ °ÔÀÓ È­¸é¿¡ Ãß°¡ Á¤º¸µéÀ» Ç¥½ÃÇÏ´Â class<br>
...
//			}
			...
			while(it.hasNext())
			{
				...
				int numDeadUnits = 0;//InformationManager.Instance().getUnitData(InformationManager.Instance().enemyPlayer).getNumDeadUnits(tempUnitName);
		...
		// ¾Æ±ºÀÇ UnitType º° ÆÄ¾ÇµÈ Unit ¼ýÀÚ¸¦ Ç¥½Ã
...
//			System.out.println(blueCount + " " + cyanCount + " " + orangeCount + " " + yellowCount + " " + greenCount + " " + redCount);
		...
		if(hasSavedBWTAInfo)
		{
			...
			// OccupiedBaseLocation À» ¿øÀ¸·Î Ç¥½Ã
			...
			// ChokePoint, BaseLocation À» ÅØ½ºÆ®·Î Ç¥½Ã
